...
import iastate.edu.User.UserController;
import iastate.edu.User.UserRepository;

/**
 * @author Daniel Nikolic
 */
public class Demo5_UserTest 
{
	...
	public void getPassword() 
	{
		...
		assertEquals(false, users.get(0).isAdmin());
		...
		assertEquals(false, users.get(1).isAdmin());
	...
	public void isUser()
	{
		...
		userRepo.deleteUserEntry("hsellars");
